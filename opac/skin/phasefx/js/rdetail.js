...
var rdetailRefWorksHost = 'http://rlproxy.upei.ca/login?url=http://refworks.scholarsportal.info';
...
function rdetailShowExtra(type, args) {
	...
	hideMe($('rdetail_bib_toc_div'));
	hideMe($('rdetail_more_details_div'));
	...
	removeCSSClass($('rdetail_bib_toc_link'), 'rdetail_extras_selected');
	removeCSSClass($('rdetail_more_details_link'), 'rdetail_extras_selected');
	switch(type) {
		...
		case "bib_toc": 
			addCSSClass($('rdetail_bib_toc_link'), 'rdetail_extras_selected');
			unHideMe($('rdetail_bib_toc_div'));
			break;

		case "more_details": 
			addCSSClass($('rdetail_more_details_link'), 'rdetail_extras_selected');
			unHideMe($('rdetail_more_details_div'));
			break;
